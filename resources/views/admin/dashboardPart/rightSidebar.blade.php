          ...
          <a href="" class="media-list-link">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="tx-13 mg-t-10 mg-b-0">I should be incapable of drawing a single stroke at the present moment{{asset('')}} backend.</p>
              </div>
            </div><!-- media -->
          </a>
          <a href="" class="media-list-link">
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="tx-13 mg-t-10 mg-b-0">When, while the lovely valley teems with vapour around me, and the meridian sun strikes{{asset('')}} backend.</p>
              </div>
            </div><!-- media -->
          </a>
          <a href="" class="media-list-link">
