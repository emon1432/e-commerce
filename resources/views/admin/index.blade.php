            ...
            <div class="list-group list-group-flush">
              <a href="" class="list-group-item list-group-item-action media">
                ...
                <div class="media-body">
                  ...
                  <p class="msg-summary">Many desktop publishing packages and web page editors now use{{asset('')}} backend.</p>
                </div><!-- media-body -->
              </a><!-- list-group-item -->
              <a href="" class="list-group-item list-group-item-action media">
                ...
                <div class="media-body">
                  ...
                  <p class="msg-summary">On the other hand, we denounce with righteous indignation and dislike{{asset('')}} backend.</p>
                </div><!-- media-body -->
              </a><!-- list-group-item -->
              <a href="" class="list-group-item list-group-item-action media">
                ...
                <div class="media-body">
                  ...
                  <p class="msg-summary">It is a long established fact that a reader will be distracted by the readable{{asset('')}} backend.</p>
                </div><!-- media-body -->
              </a><!-- list-group-item -->
              <a href="" class="list-group-item list-group-item-action media">
                ...
                <div class="media-body">
                  ...
                  <p class="msg-summary">Than the fact that climate change may be causing it to rapidly disappear{{asset('')}} backend. </p>
                </div><!-- media-body -->
              </a><!-- list-group-item -->
            </div><!-- list-group -->
