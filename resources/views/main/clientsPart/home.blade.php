    ...
    <div class="banner">
        ...
        <div class="container fill_height">
            <div class="row fill_height">
                <div class="banner_product_image"><img src="{{ asset($slider->image_one) }}" alt="" style="height: 450px;">
                </div>
                                    ...
                                    @foreach ($feature as $row)
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                {{-- Wishlist Button  --}}
                                                <a aria-label="Add To Wishlist" class="product_fav add_to_wishlist"
                                                    title="Add to Wishlist" type="submit">
                                                    <input type="hidden" value="{{ $row->id }}">
                                                    {{-- <i class="fas fa-heart" id="activeWishlistItem"></i> --}}
                                                    @php
                                                        $wishlist_item = 0;
                                                        if (Auth::user()) {
                                                            $wishlist_item = DB::table('wishlists')
                                    ...
                                    <div class="col-lg-4 col-md-6 fill_height">
                                        <div class="banner_2_content">
                                            ...
                                            <div class="banner_2_text">
                                                ...
                                                <h2 style="color: red;">${{ $row->selling_price }}</h2>
                                            </div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img src="{{ asset($row->image_one) }}" alt=""
                                                    style="height: 375px; width: 250px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
